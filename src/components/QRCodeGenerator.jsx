...
import { Loader2, Copy, Download, Settings, Palette, Users, Zap, Frame } from "lucide-react";
...
const QRCodeGenerator = () => {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto shadow-xl border-2 border-gradient-to-r from-blue-200 to-purple-200">
